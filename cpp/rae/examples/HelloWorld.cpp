...
{	
	...
	name = "Hello Rae World";//line: 68
	afloat = 248.52;//line: 67
	anotherNumber = 42;//line: 65
	no_init_datad = 0.0;//line: 64
	no_init_data = 0;//line: 63
...
void HelloWorld::doesnotwork(std::vector<int32_t> someints)
{
	someints.emplace_back(2);//line: 32
	std::cout<<someints.at(0)<<"\n";
}

void HelloWorld::sayHello()
{
	std::vector<int32_t> my_numbers;//line: 39
	my_numbers.emplace_back(5);//line: 40
	my_numbers.emplace_back(6);//line: 41
	my_numbers.emplace_back(7);//line: 42
...
{
	std::string helloRae = "What? Hello Rae World";//line: 95
	std::cout<<helloRae<<"\n";//line: 96
	...
	rae::link<Tester> tester_lnk;//line: 107
	tester_lnk.linkTo(&hello.tester);//line: 108
	
	std::cout<<"LINK saying hello:"<<"\n";//line: 110
	tester_lnk.obj->logMe();//line: 111
	
	hello.sayHello();//line: 113
	
	std::cout<<"5 + 2 = ";//line: 115
	
	std::cout<<hello.count(hello.num, hello.tester_opt)<<"\n";//line: 117
	
	hello.tester.data = 3;//line: 119
	
	hello.array_test.push_back(9);//line: 121
	hello.array_test.push_back(7);//line: 122
	hello.array_test.push_back(4);//line: 123
	
	hello.tester_opts.push_back(hello.tester_opt);//line: 125
	
	hello.tester_links.emplace_back();//line: 127
	hello.tester_links.at(0).linkTo(&hello.tester);//line: 128
	std::cout<<"LINK in an array saying hello: "<<"\n";//line: 129
	hello.tester_links.at(0).obj->logMe();//line: 130
	std::cout<<"Ok. Said hello."<<"\n";//line: 131
	hello.tester_links.at(0).obj->data = 8;//line: 132
	std::cout<<"an eight = "<<hello.tester_links.at(0).obj->data<<"\n";
	
	hello.array_test.at(0);//line: 135
