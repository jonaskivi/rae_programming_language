...
solution "rae_hello"
   ...
   project "rae_hello"
      ...
      language "C++"
      targetdir "./"
      files { "cpp/rae/*.hpp", "cpp/rae/*.cpp", "cpp/rae/examples/HelloWorld.hpp", "cpp/rae/examples/HelloWorld.cpp" }
      includedirs { "cpp", "cpp/rae", "cpp/rae/examples" --[["external/glew/include", "external/glfw/include", "external/nanovg/src", "external/glm", "external/glm/glm", "rae", "external/"--]] }
